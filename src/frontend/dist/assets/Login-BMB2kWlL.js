import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, N as o, O as vt, a as useNavigate, u as useSearch, E as useAuthStore, H as Mail, U as User } from "./index-CWjEpYzx.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-DcnNbM1P.js";
...
function Login() {
  ...
  async function handleSignupContinue(e) {
    e.preventDefault();
  ...
  async function handleVerifyOTP(e) {
    ...
    setVerifying(true);
    try {
      const nameToRegister = fullName.trim() || void 0;
      const result = method === "phone" ? await verifyOTP(phone, otp, nameToRegister) : await verifyEmailOTP(email, otp, nameToRegister);
      if (result === "ok") {
          ...
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 sm:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-foreground mb-2", children: "Sign In / Sign Up" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Continue to place your order securely" })
                      ] }),
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      method === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-8", children: "We'll send a secure OTP to verify your number" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSendPhoneOTP, noValidate: true, children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              children: sending ? "Sending..." : "CONTINUE"
                            }
                          )
                        ] })
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-8", children: "We'll send a secure OTP to verify your email" }),
                ...
                step === "signup" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    initial: { opacity: 0, x: 16 },
                    animate: { opacity: 1, x: 0 },
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-2", children: "Welcome! Just one quick step to get started." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70 mb-8 font-mono truncate", children: identifier }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSignupContinue, noValidate: true, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "label",
                            {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            ...
                            children: sending ? "Sending OTP..." : "SEND OTP"
                          }
                        )
                      ] })
                    ]
                ...
                step === "otp" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-foreground mb-2", children: "Enter OTP" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: method === "phone" ? "OTP sent to your mobile number" : "OTP sent to your email address" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mt-1 truncate", children: maskedIdentifier }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground/60 mt-1", children: "Valid for 5 minutes" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleVerifyOTP, noValidate: true, children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            ...
                            children: verifying ? "Verifying..." : "VERIFY & SIGN IN"
                          }
                        )
                      ] }),
