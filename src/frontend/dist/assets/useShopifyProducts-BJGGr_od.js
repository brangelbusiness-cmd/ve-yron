    ...
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square w-full overflow-hidden bg-muted", children: [
          primaryImage ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: primaryImage.src,
                alt: primaryImage.alt,
                className: `absolute inset-0 w-full h-full object-cover transition-all duration-500 ${hoverImage ? "group-hover:opacity-0 opacity-100" : "group-hover:scale-105"}`,
                loading: "lazy"
              }
            ),
            hoverImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: hoverImage.src,
                alt: hoverImage.alt,
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-widest", children: "No Image" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/0 group-hover:bg-background/20 transition-colors duration-300 flex items-end justify-center pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[10px] font-black uppercase tracking-[0.2em] text-foreground bg-card/90 px-3 py-1.5", children: "View" }) }),
          product.badge && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `absolute top-2 left-2 text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-sm ${BADGE_STYLES[product.badge] ?? "bg-muted text-muted-foreground"}`,
              children: BADGE_LABELS[product.badge] ?? product.badge
            }
          ),
          !isAvailable && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/60 flex items-end justify-center pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground bg-card/80 px-3 py-1", children: "Sold Out" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 md:p-4", children: [
          showGenderBadge && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] font-bold uppercase tracking-[0.2em] text-primary mb-1", children: [
            GENDER_LABELS[product.genderCategory],
            " \\u00b7 ",
            product.category
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: displayPrice > 0 ? "#d4af37" : void 0 },
              children: displayPrice > 0 ? formatPrice(displayPrice) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: "Price unavailable" })
            }
          )
        ] })
      ]
...
function useShopifyProduct(handle) {
  const q = useQuery({
...
export {
  ProductCard as P,
  SEO as S,
  useWomensProducts as a,
  usePlusMensProducts as b,
  useAllProducts as c,
  useShopifyProduct as d,
  useMensProducts as u
};
